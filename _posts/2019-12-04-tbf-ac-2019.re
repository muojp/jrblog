...
//footnote[rpi-baremetal][近いトピックとしてはRaspberry-PiでRustベアメタルをやっていく本があり（これも技術書典で購入しました）あちらはあちらで好みなのですが、今回は1冊に絞って推すぞと決めたので、そちらは別の機会に紹介します]

== GBA?

初代ゲームボーイはZ80系の8-bit CPUだったのが、GBAは32-bitのArmということで相応に時代が進んだのを感じつつ、楽しく読みました。

携帯用ゲーム機はつまりバッテリー駆動でモニタや入力デバイスに音声アンプまで搭載したArm CPUベースのシングルボードコンピューター（SBC）@<fn>{sbc}といえます。
...
とことん、無理なく読むことができる構成ながらしっかり読もうと思えば得られるものが多いし、脚注での参考文献も書き込まれている※ただしGBA実機へ転送してハンズオンできる人はたぶんかなり少ない、という面白い本だなという感想でした。
